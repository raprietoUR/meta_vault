...
--depends on: edw.raw_data.model_load_runs, edw.raw_data.raw_init, EDW.raw_data.datasets_fields_columns_tmp, edw.raw_data.raw_init
	...
	FROM  EDW.raw_data.datasets_fields_columns_tmp T
LEFT JOIN (SELECT
			COD_MODEL,
			DT_MODEL_LOAD,
			ID_MODEL_RUN,
