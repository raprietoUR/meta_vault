...
INNER JOIN  edw.gen_phase.environment_connections EC ON SC.COD_CONNECTION = EC.COD_CONNECTION AND EC.COD_ENVIRONMENT = 'COD_ENVIRONMENT'
...
INNER JOIN  edw.gen_phase.model_load_runs_last M
 ...
 LEFT JOIN edw.raw_data.relationships REL_1  		ON DS.COD_DATASET = REL_1.REFERENCE_COD_DATASET AND DS.ID_MODEL_RUN = REL_1.ID_MODEL_RUN
 LEFT JOIN edw.raw_data.relationships REL_2  		ON DS.COD_DATASET = REL_2.TARGET_COD_DATASET  AND DS.ID_MODEL_RUN = REL_2.ID_MODEL_RUN
 WHERE
