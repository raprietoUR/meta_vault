...
SELECT TMP.COD_DATASET,TMP.ID_ORDER,TMP.COD_DATASET_FIELD,TMP.COD_TYPE,TMP.COD_COLUMN_NAME_TARGET, TMP."DESC", '1' SW_TRACK_DIFF, '0' SW_ACTIVE_VALUE_DEFAULT, '' COLUMN_VALUE_DEFAULT_FX, '0' SW_VIRTUAL_FIELD_VALUE, ' Business Description' DESC_BUSINESS_DESCRIPTION
, 0 SW_CLUSTERIZABLE
