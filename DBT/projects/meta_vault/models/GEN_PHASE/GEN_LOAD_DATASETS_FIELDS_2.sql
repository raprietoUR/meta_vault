...
FROM  {{ ref('GEN_LOAD_RELATIONSHIPS_FINAL') }} REL JOIN
	 {{ ref('GEN_LOAD_DATASETS_FIELDS_1') }} DS_FIELDS ON REL.REFERENCE_COD_DATASET = DS_FIELDS.COD_DATASET 
UNION	 
SELECT DISTINCT REL.COD_RELATIONSHIP COD_DATASET ,
    ...
    DS_FIELDS.DESC_BUSINESS_DESCRIPTION 
FROM  {{ ref('GEN_LOAD_RELATIONSHIPS_FINAL') }} REL JOIN
	 {{ ref('GEN_LOAD_DATASETS_FIELDS_1') }} DS_FIELDS ON REL.TARGET_COD_DATASET = DS_FIELDS.COD_DATASET )